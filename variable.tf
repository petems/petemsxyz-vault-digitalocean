...
variable "petems_xyz_vault_ssh_private" {
  description = "Location of Vault Specific SSH Private Key"
  default     = "/Users/psouter/.ssh/petems-xyz-vault"
}

variable "petems_xyz_vault_ssh_pub" {
  description = "Location of Vault Specific SSH Pub Key"
  default     = "/Users/psouter/.ssh/petems-xyz-vault.pub"
}

## DNS Settings

variable "petems_vault_domain" {
  description = "Domain that the petems.xyz Vault is hosted on"
  default     = "vault.petems.xyz"
}
